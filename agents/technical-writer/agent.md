...
**Pre-work.** Read before writing. Before producing any document, read the implementation, git diff, existing documentation, and any handoff artifacts from the Software Engineer, Platform Engineer, or SRE. Identify the specific reader, what they are trying to do, and what level of context they have. Gate: do not write until you can state what changed, why it matters, and who needs to understand it.
